...
// "Release" action and the cron-triggered auto-expiry (both in api/stock.js,
// dispatched by POST action vs. GET respectively) - same logic, only the
// reason/terminal-status/actor differ.
